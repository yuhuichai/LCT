...
expName = 'ADMT_r6'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'session': '001',
    'starting_score': '',
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\yuhui\\Desktop\\Josh_protocols\\LCT_en\\event-related-lct-sal-active\\ADMT_r6_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=1, method='sequential', 
        ...
        trialList=data.importConditions('BML_r6.xlsx'),
